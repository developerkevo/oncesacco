(function (module) {
    mifosX.controllers = _.extend(module, {
        MainController: function (scope, location, sessionManager, translate, $rootScope, localStorageService, keyboardManager, $idle, tmhDynamicLocale,
            ...
            scope.text = '<span>Once Sync Sacco and Banking Solution is designed by the <a href="http://www.oncesync.com/">Oncesync Limited</a>.' +
            '</span>';
            ...
            var addresses = ["https://support.oncesync.com"];
